<#
.DESCRIPTION
    Atome SPECTRE pour MitreID : T1016
    Nom : System Network Configuration Discovery
    Categorie : G_Governance
#>

function Invoke-AtomeDebug {
    param([string]$Message)
    Write-Host "[(Get-Date -Format 'HH:mm:ss')][DEBUG][T1016] $Message" -ForegroundColor Gray
}
