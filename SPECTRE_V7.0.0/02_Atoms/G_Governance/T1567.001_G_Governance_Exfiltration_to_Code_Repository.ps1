<#
.DESCRIPTION
    Atome SPECTRE pour MitreID : T1567.001
    Nom : Exfiltration to Code Repository
    Categorie : G_Governance
#>

function Invoke-AtomeDebug {
    param([string]$Message)
    Write-Host "[(Get-Date -Format 'HH:mm:ss')][DEBUG][T1567.001] $Message" -ForegroundColor Gray
}
