<#
.DESCRIPTION
    Atome SPECTRE pour MitreID : T1011
    Nom : Exfiltration Over Other Network Medium
    Categorie : G_Governance
#>

function Invoke-AtomeDebug {
    param([string]$Message)
    Write-Host "[(Get-Date -Format 'HH:mm:ss')][DEBUG][T1011] $Message" -ForegroundColor Gray
}
