<#
.DESCRIPTION
    Atome SPECTRE pour MitreID : T1140
    Nom : Deobfuscate/Decode Files or Information
    Categorie : G_Governance
#>

function Invoke-AtomeDebug {
    param([string]$Message)
    Write-Host "[(Get-Date -Format 'HH:mm:ss')][DEBUG][T1140] $Message" -ForegroundColor Gray
}
