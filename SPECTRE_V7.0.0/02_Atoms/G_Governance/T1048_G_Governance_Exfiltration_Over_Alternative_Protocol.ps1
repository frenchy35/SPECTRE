<#
.DESCRIPTION
    Atome SPECTRE pour MitreID : T1048
    Nom : Exfiltration Over Alternative Protocol
    Categorie : G_Governance
#>

function Invoke-AtomeDebug {
    param([string]$Message)
    Write-Host "[(Get-Date -Format 'HH:mm:ss')][DEBUG][T1048] $Message" -ForegroundColor Gray
}
