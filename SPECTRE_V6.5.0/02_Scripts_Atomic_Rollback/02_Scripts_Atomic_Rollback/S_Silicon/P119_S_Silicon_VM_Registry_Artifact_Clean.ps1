...
if ($null -eq $Context) { Write-Error "[FATAL] Context Failure 119"; return }

# --- HEADER VERBOSE (14 ITEMS) ---
Write-Host "`n[ATOME 119] VM_Registry_Artifact_Clean" -ForegroundColor Cyan -Bold
