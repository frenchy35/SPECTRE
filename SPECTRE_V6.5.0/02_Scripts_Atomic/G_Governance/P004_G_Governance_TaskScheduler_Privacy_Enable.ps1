<#
    ID: 004 | Name: TaskScheduler_Privacy_Enable
    Artifact de comportement : V4.9.3 Lock
    Description : Masquage des taches planifiees via l'interface utilisateur standard
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "004"

Write-Host "`n[ATOME 004] TaskScheduler_Privacy_Enable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="004"; Name="TaskScheduler_Privacy_Enable"; Status="ANALYSE_$Status"; Updated=$false}
}
