<#
    ...
    Description : Limitation de l'enumeration des cles de registre pour les utilisateurs non-privilegies
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="006"; Name="Registry_Enumeration_Limit"; Status="ANALYSE_$Status"; Updated=$false}
}
