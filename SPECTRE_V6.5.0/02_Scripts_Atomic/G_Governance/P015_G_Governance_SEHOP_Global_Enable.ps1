<#
    ID: 015 | Name: SEHOP_Global_Enable
    Artifact de comportement : V4.9.3 Lock
    Description : Activation globale de la protection SEHOP contre l'écrasement de gestionnaire d'exceptions
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "015"

Write-Host "`n[ATOME 015] SEHOP_Global_Enable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="015"; Name="SEHOP_Global_Enable"; Status="ANALYSE_$Status"; Updated=$false}
}
