<#
    ID: 020 | Name: NullSession_Access_Restrict
    Artifact de comportement : V4.9.3 Lock
    Description : Restriction de l'acces anonyme aux partages et aux pipes nommes
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "020"

Write-Host "`n[ATOME 020] NullSession_Access_Restrict" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="020"; Name="NullSession_Access_Restrict"; Status="ANALYSE_$Status"; Updated=$false}
}
