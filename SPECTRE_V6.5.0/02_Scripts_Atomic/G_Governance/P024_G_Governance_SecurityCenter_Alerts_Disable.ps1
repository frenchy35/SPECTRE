<#
    ID: 024 | Name: SecurityCenter_Alerts_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation des alertes visuelles du Security Center pour la furtivite
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "024"

Write-Host "`n[ATOME 024] SecurityCenter_Alerts_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="024"; Name="SecurityCenter_Alerts_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
