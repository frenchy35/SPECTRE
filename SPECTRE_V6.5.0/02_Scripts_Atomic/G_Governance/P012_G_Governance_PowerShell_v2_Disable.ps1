<#
    ID: 012 | Name: PowerShell_v2_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du moteur PS v2 pour empecher le downgrade attack
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "012"

Write-Host "`n[ATOME 012] PowerShell_v2_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="012"; Name="PowerShell_v2_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
