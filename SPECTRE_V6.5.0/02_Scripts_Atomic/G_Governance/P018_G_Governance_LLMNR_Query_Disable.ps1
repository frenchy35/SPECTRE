<#
    ID: 018 | Name: LLMNR_Query_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de LLMNR pour prevenir les attaques de type empoisonnement (Responder)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "018"

Write-Host "`n[ATOME 018] LLMNR_Query_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="018"; Name="LLMNR_Query_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
