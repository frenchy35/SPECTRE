<#
    ID: 016 | Name: SMBv1_Server_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du serveur SMBv1 (Protocole obsolete/critique)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "016"

Write-Host "`n[ATOME 016] SMBv1_Server_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="016"; Name="SMBv1_Server_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
