<#
    ID: 013 | Name: LSA_RunAsPPL_Enable
    Artifact de comportement : V4.9.3 Lock
    Description : Forcage de LSA comme processus protege pour bloquer les dumpers type LSASS/Mimikatz
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "013"

Write-Host "`n[ATOME 013] LSA_RunAsPPL_Enable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="013"; Name="LSA_RunAsPPL_Enable"; Status="ANALYSE_$Status"; Updated=$false}
}
