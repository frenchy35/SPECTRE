<#
    ID: 021 | Name: SMB_Signing_Require
    Artifact de comportement : V4.9.3 Lock
    Description : Signature SMB obligatoire pour le serveur (Anti-Relay)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "021"

Write-Host "`n[ATOME 021] SMB_Signing_Require" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="021"; Name="SMB_Signing_Require"; Status="ANALYSE_$Status"; Updated=$false}
}
