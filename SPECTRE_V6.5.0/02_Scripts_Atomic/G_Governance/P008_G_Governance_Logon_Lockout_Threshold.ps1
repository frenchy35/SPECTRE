<#
    ID: 008 | Name: Logon_Lockout_Threshold
    Artifact de comportement : V4.9.3 Lock
    Description : Seuil de verrouillage des comptes apres echecs de connexion (Protection Brute-Force)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "008"

Write-Host "`n[ATOME 008] Logon_Lockout_Threshold" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="008"; Name="Logon_Lockout_Threshold"; Status="ANALYSE_$Status"; Updated=$false}
}
