<#
    ID: 002 | Name: LogonScripts_Delay_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Suppression du delai d'execution des scripts d'ouverture de session (Group Policy Override)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "002"

Write-Host "`n[ATOME 002] LogonScripts_Delay_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="002"; Name="LogonScripts_Delay_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
