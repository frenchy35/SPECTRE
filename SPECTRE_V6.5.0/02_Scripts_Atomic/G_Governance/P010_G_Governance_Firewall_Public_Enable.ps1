<#
    ID: 010 | Name: Firewall_Public_Enable
    Artifact de comportement : V4.9.3 Lock
    Description : Activation obligatoire du pare-feu pour le profil Public
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "010"

Write-Host "`n[ATOME 010] Firewall_Public_Enable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="010"; Name="Firewall_Public_Enable"; Status="ANALYSE_$Status"; Updated=$false}
}
