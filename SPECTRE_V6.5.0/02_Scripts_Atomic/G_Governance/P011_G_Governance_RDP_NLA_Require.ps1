<#
    ID: 011 | Name: RDP_NLA_Require
    Artifact de comportement : V4.9.3 Lock
    Description : Forcage de l'authentification NLA pour les sessions RDP
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "011"

Write-Host "`n[ATOME 011] RDP_NLA_Require" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="011"; Name="RDP_NLA_Require"; Status="ANALYSE_$Status"; Updated=$false}
}
