<#
    ID: 023 | Name: DEP_Global_Policy
    Artifact de comportement : V4.9.3 Lock
    Description : Forcage de DEP (Data Execution Prevention) au niveau OptOut
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "023"

Write-Host "`n[ATOME 023] DEP_Global_Policy" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="023"; Name="DEP_Global_Policy"; Status="ANALYSE_$Status"; Updated=$false}
}
