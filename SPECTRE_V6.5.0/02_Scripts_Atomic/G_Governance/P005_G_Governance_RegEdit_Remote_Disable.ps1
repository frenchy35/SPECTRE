<#
    ID: 005 | Name: RegEdit_Remote_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'acces a distance au registre (Remote Registry Service Control)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "005"

Write-Host "`n[ATOME 005] RegEdit_Remote_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="005"; Name="RegEdit_Remote_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
