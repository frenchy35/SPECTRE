<#
    ID: 022 | Name: EventLog_Security_Size
    Artifact de comportement : V4.9.3 Lock
    Description : Augmentation de la taille du journal de securite (Retention accrue)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "022"

Write-Host "`n[ATOME 022] EventLog_Security_Size" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="022"; Name="EventLog_Security_Size"; Status="ANALYSE_$Status"; Updated=$false}
}
