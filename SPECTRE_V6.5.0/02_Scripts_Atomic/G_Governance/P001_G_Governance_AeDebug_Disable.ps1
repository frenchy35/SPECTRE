<#
    ...
    Description : Neutralisation du debugger post-mortem AeDebug pour empecher l'auto-dumping de crash exploitable
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="001"; Name="AeDebug_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
