<#
    ...
    Description : Desactivation totale de l'execution automatique pour tous les lecteurs
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="014"; Name="USB_Autorun_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
