<#
    ID: 017 | Name: WDigest_Auth_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Empeche le stockage des mots de passe en clair dans la memoire via WDigest
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "017"

Write-Host "`n[ATOME 017] WDigest_Auth_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="017"; Name="WDigest_Auth_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
