<#
    ...
    Description : Suppression du suffixe '- Raccourci' lors de la creation de liens
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="522"; Name="Shortcut_Suffix_Remove"; Status="ANALYSE_$Status"; Updated=$false}
}
