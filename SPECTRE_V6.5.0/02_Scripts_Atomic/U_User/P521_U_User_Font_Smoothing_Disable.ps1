<#
    ID: 521 | Name: Font_Smoothing_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du lissage des polices pour reduire le fingerprinting GPU/UI
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "521"

Write-Host "`n[ATOME 521] Font_Smoothing_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="521"; Name="Font_Smoothing_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
