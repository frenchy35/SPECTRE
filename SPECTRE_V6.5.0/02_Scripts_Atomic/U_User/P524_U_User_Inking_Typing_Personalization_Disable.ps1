<#
    ID: 524 | Name: Inking_Typing_Personalization_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de la personnalisation de l'ecriture et de la frappe
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "524"

Write-Host "`n[ATOME 524] Inking_Typing_Personalization_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="524"; Name="Inking_Typing_Personalization_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
