<#
    ID: 505 | Name: Superfetch_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de Superfetch (SysMain)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "505"

Write-Host "`n[ATOME 505] Superfetch_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="505"; Name="Superfetch_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
