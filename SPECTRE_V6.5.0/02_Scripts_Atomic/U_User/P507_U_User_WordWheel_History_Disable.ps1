<#
    ID: 507 | Name: WordWheel_History_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Nettoyage automatique de l'historique de recherche de l'explorateur
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "507"

Write-Host "`n[ATOME 507] WordWheel_History_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="507"; Name="WordWheel_History_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
