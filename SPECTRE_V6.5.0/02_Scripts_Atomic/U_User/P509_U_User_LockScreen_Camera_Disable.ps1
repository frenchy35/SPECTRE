<#
    ...
    Description : Desactivation de l'acces a la camera depuis l'ecran de verrouillage
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="509"; Name="LockScreen_Camera_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
