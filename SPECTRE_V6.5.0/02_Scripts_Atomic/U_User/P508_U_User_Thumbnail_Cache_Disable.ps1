<#
    ID: 508 | Name: Thumbnail_Cache_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de la mise en cache des miniatures (Thumbs.db)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "508"

Write-Host "`n[ATOME 508] Thumbnail_Cache_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="508"; Name="Thumbnail_Cache_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
