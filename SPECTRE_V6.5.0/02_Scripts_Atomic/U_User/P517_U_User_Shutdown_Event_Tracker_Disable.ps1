<#
    ID: 517 | Name: Shutdown_Event_Tracker_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du suivi des evenements d'extinction (Anti-Forensics)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "517"

Write-Host "`n[ATOME 517] Shutdown_Event_Tracker_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="517"; Name="Shutdown_Event_Tracker_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
