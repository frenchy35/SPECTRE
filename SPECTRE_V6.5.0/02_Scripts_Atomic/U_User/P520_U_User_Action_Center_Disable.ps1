<#
    ...
    Description : Suppression du Centre de notifications de la barre des taches
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="520"; Name="Action_Center_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
