<#
    ID: 523 | Name: PageFile_Clear_At_Shutdown
    Artifact de comportement : V4.9.3 Lock
    Description : Effacement du fichier d'echange (Pagefile) a chaque extinction
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "523"

Write-Host "`n[ATOME 523] PageFile_Clear_At_Shutdown" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="523"; Name="PageFile_Clear_At_Shutdown"; Status="ANALYSE_$Status"; Updated=$false}
}
