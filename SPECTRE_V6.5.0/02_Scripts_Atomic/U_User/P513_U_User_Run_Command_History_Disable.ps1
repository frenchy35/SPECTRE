<#
    ID: 513 | Name: Run_Command_History_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Nettoyage de l'historique de la boite de dialogue 'Executer'
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "513"

Write-Host "`n[ATOME 513] Run_Command_History_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="513"; Name="Run_Command_History_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
