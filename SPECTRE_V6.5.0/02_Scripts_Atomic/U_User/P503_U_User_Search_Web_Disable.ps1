<#
    ID: 503 | Name: Search_Web_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Interdiction de la recherche Bing dans le menu Demarrer
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "503"

Write-Host "`n[ATOME 503] Search_Web_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="503"; Name="Search_Web_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
