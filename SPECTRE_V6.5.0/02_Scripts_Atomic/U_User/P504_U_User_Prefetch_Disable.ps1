<#
    ID: 504 | Name: Prefetch_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du Prefetcher pour limiter les artifacts d'execution
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "504"

Write-Host "`n[ATOME 504] Prefetch_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="504"; Name="Prefetch_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
