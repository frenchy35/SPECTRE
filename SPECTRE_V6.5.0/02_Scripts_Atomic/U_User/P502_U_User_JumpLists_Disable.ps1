<#
    ID: 502 | Name: JumpLists_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Suppression des listes de raccourcis (Jump Lists) des applications
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "502"

Write-Host "`n[ATOME 502] JumpLists_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="502"; Name="JumpLists_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
