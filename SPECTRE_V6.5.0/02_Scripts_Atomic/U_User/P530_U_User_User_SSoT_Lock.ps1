<#
    ID: 530 | Name: User_SSoT_Lock
    Artifact de comportement : V4.9.3 Lock
    Description : Point final de validation de l'integrite du segment U
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "530"

Write-Host "`n[ATOME 530] User_SSoT_Lock" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="530"; Name="User_SSoT_Lock"; Status="ANALYSE_$Status"; Updated=$false}
}
