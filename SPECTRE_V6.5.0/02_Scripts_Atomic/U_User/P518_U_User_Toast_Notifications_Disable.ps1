<#
    ID: 518 | Name: Toast_Notifications_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Blocage global des notifications Toast (Bannieres)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "518"

Write-Host "`n[ATOME 518] Toast_Notifications_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="518"; Name="Toast_Notifications_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
