<#
    ID: 511 | Name: GameDVR_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de Windows Game Recording and Broadcasting
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "511"

Write-Host "`n[ATOME 511] GameDVR_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="511"; Name="GameDVR_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
