<#
    ID: 512 | Name: Typed_Paths_History_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Suppression de l'historique des chemins saisis dans la barre d'adresse
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "512"

Write-Host "`n[ATOME 512] Typed_Paths_History_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="512"; Name="Typed_Paths_History_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
