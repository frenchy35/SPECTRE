<#
    ID: 506 | Name: LockScreen_Ads_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Suppression des astuces et publicites sur l'ecran de verrouillage
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "506"

Write-Host "`n[ATOME 506] LockScreen_Ads_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="506"; Name="LockScreen_Ads_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
