<#
    ID: 527 | Name: Explorer_Typed_Paths_Clear
    Artifact de comportement : V4.9.3 Lock
    Description : Effacement forcé de l'historique des dossiers visités
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "527"

Write-Host "`n[ATOME 527] Explorer_Typed_Paths_Clear" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="527"; Name="Explorer_Typed_Paths_Clear"; Status="ANALYSE_$Status"; Updated=$false}
}
