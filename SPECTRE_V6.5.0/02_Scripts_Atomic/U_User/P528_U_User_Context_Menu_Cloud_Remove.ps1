<#
    ID: 528 | Name: Context_Menu_Cloud_Remove
    Artifact de comportement : V4.9.3 Lock
    Description : Suppression des entrees Cloud du menu contextuel (Share, OneDrive)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "528"

Write-Host "`n[ATOME 528] Context_Menu_Cloud_Remove" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="528"; Name="Context_Menu_Cloud_Remove"; Status="ANALYSE_$Status"; Updated=$false}
}
