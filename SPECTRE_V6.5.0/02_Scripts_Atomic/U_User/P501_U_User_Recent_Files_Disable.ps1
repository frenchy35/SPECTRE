<#
    ...
    Description : Desactivation de l'historique des fichiers recents dans l'Explorateur
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="501"; Name="Recent_Files_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
