<#
    ID: 510 | Name: Feedback_Hub_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Neutralisation de l'application Hub de commentaires
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "510"

Write-Host "`n[ATOME 510] Feedback_Hub_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="510"; Name="Feedback_Hub_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
