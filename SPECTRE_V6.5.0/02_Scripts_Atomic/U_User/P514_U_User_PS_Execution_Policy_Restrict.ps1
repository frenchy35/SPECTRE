<#
    ID: 514 | Name: PS_Execution_Policy_Restrict
    Artifact de comportement : V4.9.3 Lock
    Description : Forcage de AllSigned pour l'utilisateur courant (Defense-in-depth)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "514"

Write-Host "`n[ATOME 514] PS_Execution_Policy_Restrict" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="514"; Name="PS_Execution_Policy_Restrict"; Status="ANALYSE_$Status"; Updated=$false}
}
