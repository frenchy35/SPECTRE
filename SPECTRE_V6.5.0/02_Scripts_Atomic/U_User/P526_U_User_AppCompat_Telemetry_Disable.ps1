<#
    ID: 526 | Name: AppCompat_Telemetry_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du collecteur de telemetrie de compatibilite applicative
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "526"

Write-Host "`n[ATOME 526] AppCompat_Telemetry_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="526"; Name="AppCompat_Telemetry_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
