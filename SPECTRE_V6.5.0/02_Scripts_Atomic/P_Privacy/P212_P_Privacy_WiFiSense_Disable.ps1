<#
    ...
    Description : Desactivation de WiFi-Sense (Partage automatique de credentials)
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="212"; Name="WiFiSense_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
