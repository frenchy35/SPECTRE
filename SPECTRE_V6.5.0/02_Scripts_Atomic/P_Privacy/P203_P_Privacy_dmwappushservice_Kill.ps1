<#
    ID: 203 | Name: dmwappushservice_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du service de routage de messages WAP (Push Telemetry)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "203"

Write-Host "`n[ATOME 203] dmwappushservice_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="203"; Name="dmwappushservice_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
