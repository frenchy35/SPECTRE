<#
    ID: 210 | Name: Cortana_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'assistant Cortana
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "210"

Write-Host "`n[ATOME 210] Cortana_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="210"; Name="Cortana_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
