<#
    ...
    Description : Desactivation des sondes passives NCSI pour eviter le tracking IP Microsoft
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="215"; Name="NCSI_PassiveProbe_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
