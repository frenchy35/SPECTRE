<#
    ID: 214 | Name: InventoryCollector_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du collecteur d'inventaire d'appareils Windows
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "214"

Write-Host "`n[ATOME 214] InventoryCollector_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="214"; Name="InventoryCollector_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
