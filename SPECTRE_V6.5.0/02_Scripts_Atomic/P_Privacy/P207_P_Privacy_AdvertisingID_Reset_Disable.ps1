<#
    ID: 207 | Name: AdvertisingID_Reset_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Suppression de l'identifiant de publicite
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "207"

Write-Host "`n[ATOME 207] AdvertisingID_Reset_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="207"; Name="AdvertisingID_Reset_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
