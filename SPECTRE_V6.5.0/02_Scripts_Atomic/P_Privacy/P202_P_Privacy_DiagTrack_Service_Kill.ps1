<#
    ID: 202 | Name: DiagTrack_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Neutralisation du service Connected User Experiences and Telemetry
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "202"

Write-Host "`n[ATOME 202] DiagTrack_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="202"; Name="DiagTrack_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
