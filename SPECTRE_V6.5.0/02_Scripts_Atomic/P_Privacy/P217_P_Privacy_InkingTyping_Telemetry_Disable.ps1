<#
    ID: 217 | Name: InkingTyping_Telemetry_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de la collecte des donnees de saisie manuscrite et clavier
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "217"

Write-Host "`n[ATOME 217] InkingTyping_Telemetry_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="217"; Name="InkingTyping_Telemetry_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
