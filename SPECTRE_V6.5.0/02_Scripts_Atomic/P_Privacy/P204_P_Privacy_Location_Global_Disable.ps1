<#
    ID: 204 | Name: Location_Global_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation globale des services de localisation
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "204"

Write-Host "`n[ATOME 204] Location_Global_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="204"; Name="Location_Global_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
