<#
    ID: 219 | Name: CloudSearch_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Interdiction de la recherche web via le menu Demarrer
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "219"

Write-Host "`n[ATOME 219] CloudSearch_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="219"; Name="CloudSearch_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
