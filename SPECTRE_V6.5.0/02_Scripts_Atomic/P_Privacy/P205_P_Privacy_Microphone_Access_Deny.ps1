<#
    ...
    Description : Interdiction pour les applications d'acceder au microphone
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="205"; Name="Microphone_Access_Deny"; Status="ANALYSE_$Status"; Updated=$false}
}
