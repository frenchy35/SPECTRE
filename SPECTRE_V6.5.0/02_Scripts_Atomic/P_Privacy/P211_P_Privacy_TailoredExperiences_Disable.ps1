<#
    ID: 211 | Name: TailoredExperiences_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation des experiences personnalisees (Cloud Data Collection)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "211"

Write-Host "`n[ATOME 211] TailoredExperiences_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="211"; Name="TailoredExperiences_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
