<#
    ID: 220 | Name: ActivityHistory_Local_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'historique des activites locales
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "220"

Write-Host "`n[ATOME 220] ActivityHistory_Local_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="220"; Name="ActivityHistory_Local_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
