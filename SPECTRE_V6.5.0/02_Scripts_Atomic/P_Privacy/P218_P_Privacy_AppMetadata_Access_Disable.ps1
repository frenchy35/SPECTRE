<#
    ID: 218 | Name: AppMetadata_Access_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Empeche l'acces des applications aux metadonnees systeme
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "218"

Write-Host "`n[ATOME 218] AppMetadata_Access_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="218"; Name="AppMetadata_Access_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
