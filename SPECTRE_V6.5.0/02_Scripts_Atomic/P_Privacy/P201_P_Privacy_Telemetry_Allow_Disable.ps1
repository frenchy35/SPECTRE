<#
    ID: 201 | Name: Telemetry_Allow_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du niveau de telemetrie (0 = Security/Off)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "201"

Write-Host "`n[ATOME 201] Telemetry_Allow_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="201"; Name="Telemetry_Allow_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
