<#
    ID: 206 | Name: Webcam_Access_Deny
    Artifact de comportement : V4.9.3 Lock
    Description : Interdiction pour les applications d'acceder a la webcam
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "206"

Write-Host "`n[ATOME 206] Webcam_Access_Deny" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="206"; Name="Webcam_Access_Deny"; Status="ANALYSE_$Status"; Updated=$false}
}
