<#
    ID: 230 | Name: Privacy_SSoT_Lock
    Artifact de comportement : V4.9.3 Lock
    Description : Point final de validation de l'integrite du segment P
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "230"

Write-Host "`n[ATOME 230] Privacy_SSoT_Lock" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="230"; Name="Privacy_SSoT_Lock"; Status="ANALYSE_$Status"; Updated=$false}
}
