<#
    ID: 216 | Name: OneSettings_Override_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Interdiction au service OneSettings de forcer des configurations distantes
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "216"

Write-Host "`n[ATOME 216] OneSettings_Override_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="216"; Name="OneSettings_Override_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
