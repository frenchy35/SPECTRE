<#
    ID: 213 | Name: ActivityFeed_Publish_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Empeche la publication des activites utilisateur vers le Cloud
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "213"

Write-Host "`n[ATOME 213] ActivityFeed_Publish_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="213"; Name="ActivityFeed_Publish_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
