<#
    ID: 122 | Name: IDE_Controller_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Spoofing du controleur IDE/SATA
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "122"

Write-Host "`n[ATOME 122] IDE_Controller_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="122"; Name="IDE_Controller_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
