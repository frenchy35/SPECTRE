<#
    ID: 104 | Name: System_ProductName_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Changement du nom de modele du systeme
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "104"

Write-Host "`n[ATOME 104] System_ProductName_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="104"; Name="System_ProductName_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
