<#
    ID: 105 | Name: System_Family_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Definition de la famille de hardware
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "105"

Write-Host "`n[ATOME 105] System_Family_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="105"; Name="System_Family_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
