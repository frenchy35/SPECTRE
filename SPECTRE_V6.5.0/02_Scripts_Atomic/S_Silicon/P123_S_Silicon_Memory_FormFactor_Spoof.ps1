<#
    ID: 123 | Name: Memory_FormFactor_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Definit le type de RAM sur DIMM (8) au lieu de inconnu
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "123"

Write-Host "`n[ATOME 123] Memory_FormFactor_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="123"; Name="Memory_FormFactor_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
