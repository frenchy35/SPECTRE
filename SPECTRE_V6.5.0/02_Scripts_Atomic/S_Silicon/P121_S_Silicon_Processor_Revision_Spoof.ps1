<#
    ID: 121 | Name: Processor_Revision_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Modification de la revision CPU pour eviter les signatures VM connues
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "121"

Write-Host "`n[ATOME 121] Processor_Revision_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="121"; Name="Processor_Revision_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
