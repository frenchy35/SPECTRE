<#
    ID: 118 | Name: Motherboard_Product_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Spoofing du modele de carte mere
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "118"

Write-Host "`n[ATOME 118] Motherboard_Product_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="118"; Name="Motherboard_Product_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
