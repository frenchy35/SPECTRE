<#
    ID: 119 | Name: VM_Registry_Artifact_Clean
    Artifact de comportement : V4.9.3 Lock
    Description : Nettoyage des artifacts 'VMware' dans le registre Software
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "119"

Write-Host "`n[ATOME 119] VM_Registry_Artifact_Clean" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="119"; Name="VM_Registry_Artifact_Clean"; Status="ANALYSE_$Status"; Updated=$false}
}
