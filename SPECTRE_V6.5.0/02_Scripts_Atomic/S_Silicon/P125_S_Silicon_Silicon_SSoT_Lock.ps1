<#
    ID: 125 | Name: Silicon_SSoT_Lock
    Artifact de comportement : V4.9.3 Lock
    Description : Point final de validation de l'integrite du segment S
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "125"

Write-Host "`n[ATOME 125] Silicon_SSoT_Lock" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="125"; Name="Silicon_SSoT_Lock"; Status="ANALYSE_$Status"; Updated=$false}
}
