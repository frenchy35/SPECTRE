<#
    ID: 113 | Name: VMMouse_Driver_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du driver de souris virtuelle
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "113"

Write-Host "`n[ATOME 113] VMMouse_Driver_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="113"; Name="VMMouse_Driver_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
