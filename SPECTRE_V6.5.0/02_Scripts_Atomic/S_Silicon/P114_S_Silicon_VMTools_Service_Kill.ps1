<#
    ID: 114 | Name: VMTools_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Neutralisation du service VMware Tools
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "114"

Write-Host "`n[ATOME 114] VMTools_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="114"; Name="VMTools_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
