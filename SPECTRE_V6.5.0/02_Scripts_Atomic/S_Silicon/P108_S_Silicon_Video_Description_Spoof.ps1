<#
    ID: 108 | Name: Video_Description_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Masquage de la carte graphique virtuelle
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "108"

Write-Host "`n[ATOME 108] Video_Description_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="108"; Name="Video_Description_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
