<#
    ID: 107 | Name: Disk_Peripheral_Rev_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Modification de la revision peripherique SCSI
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "107"

Write-Host "`n[ATOME 107] Disk_Peripheral_Rev_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="107"; Name="Disk_Peripheral_Rev_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
