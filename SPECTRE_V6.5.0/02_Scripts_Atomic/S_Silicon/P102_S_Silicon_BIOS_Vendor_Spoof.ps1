<#
    ID: 102 | Name: BIOS_Vendor_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Spoofing du vendeur BIOS pour mimer une carte mere ASUS
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "102"

Write-Host "`n[ATOME 102] BIOS_Vendor_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="102"; Name="BIOS_Vendor_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
