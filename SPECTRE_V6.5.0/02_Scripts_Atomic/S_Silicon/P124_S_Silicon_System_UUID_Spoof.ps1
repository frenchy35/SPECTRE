<#
    ID: 124 | Name: System_UUID_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Generation d'un UUID systeme aleatoire (Artifact de conformite)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "124"

Write-Host "`n[ATOME 124] System_UUID_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="124"; Name="System_UUID_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
