<#
    ID: 111 | Name: PCI_VendorID_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Alteration des identifiants de bus PCI
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "111"

Write-Host "`n[ATOME 111] PCI_VendorID_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="111"; Name="PCI_VendorID_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
