<#
    ID: 115 | Name: Battery_Simulation_Enable
    Artifact de comportement : V4.9.3 Lock
    Description : Simule la presence d'une batterie (Artifact PC Portable)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "115"

Write-Host "`n[ATOME 115] Battery_Simulation_Enable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="115"; Name="Battery_Simulation_Enable"; Status="ANALYSE_$Status"; Updated=$false}
}
