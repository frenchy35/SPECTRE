<#
    ID: 120 | Name: VPCBus_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du Virtual PC Bus
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "120"

Write-Host "`n[ATOME 120] VPCBus_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="120"; Name="VPCBus_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
