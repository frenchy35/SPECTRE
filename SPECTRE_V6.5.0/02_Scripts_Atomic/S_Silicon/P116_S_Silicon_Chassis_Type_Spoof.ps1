<#
    ID: 116 | Name: Chassis_Type_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Force le type de chassis sur 'Desktop' (3)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "116"

Write-Host "`n[ATOME 116] Chassis_Type_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="116"; Name="Chassis_Type_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
