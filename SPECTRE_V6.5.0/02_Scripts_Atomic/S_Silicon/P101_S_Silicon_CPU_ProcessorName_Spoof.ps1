<#
    ID: 101 | Name: CPU_ProcessorName_Spoof
    Artifact de comportement : V4.9.3 Lock
    Description : Modification du nom de processeur expose au shell
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "101"

Write-Host "`n[ATOME 101] CPU_ProcessorName_Spoof" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="101"; Name="CPU_ProcessorName_Spoof"; Status="ANALYSE_$Status"; Updated=$false}
}
