<#
    ID: 426 | Name: SNMP_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du service SNMP pour eviter l'enumeration d'OID
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "426"

Write-Host "`n[ATOME 426] SNMP_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="426"; Name="SNMP_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
