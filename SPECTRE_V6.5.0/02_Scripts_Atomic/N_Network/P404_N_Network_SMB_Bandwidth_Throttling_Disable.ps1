<#
    ID: 404 | Name: SMB_Bandwidth_Throttling_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Optimisation du stack SMB pour masquer les latences de traitement suspectes
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "404"

Write-Host "`n[ATOME 404] SMB_Bandwidth_Throttling_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="404"; Name="SMB_Bandwidth_Throttling_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
