<#
    ID: 412 | Name: Firewall_Inbound_Default_Deny
    Artifact de comportement : V4.9.3 Lock
    Description : Forcage du blocage entrant par defaut pour tous les profils
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "412"

Write-Host "`n[ATOME 412] Firewall_Inbound_Default_Deny" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="412"; Name="Firewall_Inbound_Default_Deny"; Status="ANALYSE_$Status"; Updated=$false}
}
