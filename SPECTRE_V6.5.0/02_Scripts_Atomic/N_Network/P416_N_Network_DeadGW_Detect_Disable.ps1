<#
    ID: 416 | Name: DeadGW_Detect_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de la detection des passerelles mortes (Anti-Redirection)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "416"

Write-Host "`n[ATOME 416] DeadGW_Detect_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="416"; Name="DeadGW_Detect_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
