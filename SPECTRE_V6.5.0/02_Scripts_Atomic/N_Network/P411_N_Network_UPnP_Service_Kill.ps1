<#
    ID: 411 | Name: UPnP_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du service Universal Plug and Play (SSDP)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "411"

Write-Host "`n[ATOME 411] UPnP_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="411"; Name="UPnP_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
