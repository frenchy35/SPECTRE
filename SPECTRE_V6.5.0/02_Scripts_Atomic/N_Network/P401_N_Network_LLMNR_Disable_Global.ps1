<#
    ID: 401 | Name: LLMNR_Disable_Global
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation totale de Link-Local Multicast Name Resolution pour bloquer Responder
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "401"

Write-Host "`n[ATOME 401] LLMNR_Disable_Global" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="401"; Name="LLMNR_Disable_Global"; Status="ANALYSE_$Status"; Updated=$false}
}
