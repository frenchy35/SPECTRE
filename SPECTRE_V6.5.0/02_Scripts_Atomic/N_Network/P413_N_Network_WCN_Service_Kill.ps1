<#
    ID: 413 | Name: WCN_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de Windows Connect Now (WCN)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "413"

Write-Host "`n[ATOME 413] WCN_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="413"; Name="WCN_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
