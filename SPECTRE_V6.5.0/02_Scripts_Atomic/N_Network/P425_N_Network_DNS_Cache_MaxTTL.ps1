<#
    ID: 425 | Name: DNS_Cache_MaxTTL
    Artifact de comportement : V4.9.3 Lock
    Description : Augmentation du TTL du cache DNS pour reduire la frequence des requetes
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "425"

Write-Host "`n[ATOME 425] DNS_Cache_MaxTTL" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="425"; Name="DNS_Cache_MaxTTL"; Status="ANALYSE_$Status"; Updated=$false}
}
