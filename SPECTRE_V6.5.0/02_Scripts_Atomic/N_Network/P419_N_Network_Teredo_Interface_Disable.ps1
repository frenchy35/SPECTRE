<#
    ...
    Description : Desactivation de l'interface de tunnelisation Teredo
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="419"; Name="Teredo_Interface_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
