<#
    ID: 403 | Name: SMB_Server_Announce_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Empeche le serveur SMB d'annoncer sa presence sur le reseau
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "403"

Write-Host "`n[ATOME 403] SMB_Server_Announce_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="403"; Name="SMB_Server_Announce_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
