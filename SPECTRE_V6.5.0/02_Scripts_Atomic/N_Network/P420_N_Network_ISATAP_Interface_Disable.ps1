<#
    ID: 420 | Name: ISATAP_Interface_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'interface ISATAP
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "420"

Write-Host "`n[ATOME 420] ISATAP_Interface_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="420"; Name="ISATAP_Interface_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
