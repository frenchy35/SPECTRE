<#
    ID: 422 | Name: Tcp_Timestamps_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation des horodatages TCP pour empecher le calcul de l'uptime distant
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "422"

Write-Host "`n[ATOME 422] Tcp_Timestamps_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="422"; Name="Tcp_Timestamps_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
