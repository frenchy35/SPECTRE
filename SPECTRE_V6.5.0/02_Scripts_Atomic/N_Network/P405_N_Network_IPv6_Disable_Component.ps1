<#
    ID: 405 | Name: IPv6_Disable_Component
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'IPv6 pour limiter la surface d'attaque et les fuites DNS
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "405"

Write-Host "`n[ATOME 405] IPv6_Disable_Component" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="405"; Name="IPv6_Disable_Component"; Status="ANALYSE_$Status"; Updated=$false}
}
