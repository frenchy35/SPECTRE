<#
    ID: 409 | Name: NetBIOS_Interface_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de NetBIOS sur TCP/IP au niveau de l'interface
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "409"

Write-Host "`n[ATOME 409] NetBIOS_Interface_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="409"; Name="NetBIOS_Interface_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
