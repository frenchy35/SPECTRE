<#
    ID: 414 | Name: DNS_MultiHome_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Empeche l'envoi de requetes DNS sur toutes les interfaces (DNS Leak Mitigation)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "414"

Write-Host "`n[ATOME 414] DNS_MultiHome_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="414"; Name="DNS_MultiHome_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
