<#
    ...
    Description : Activation forcée du DoH pour chiffrer les requetes DNS sortantes
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="427"; Name="DNS_Over_HTTPS_Enable"; Status="ANALYSE_$Status"; Updated=$false}
}
