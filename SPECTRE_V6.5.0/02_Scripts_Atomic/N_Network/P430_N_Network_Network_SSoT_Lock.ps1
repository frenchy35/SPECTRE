<#
    ID: 430 | Name: Network_SSoT_Lock
    Artifact de comportement : V4.9.3 Lock
    Description : Point final de validation de l'integrite du segment N
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "430"

Write-Host "`n[ATOME 430] Network_SSoT_Lock" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="430"; Name="Network_SSoT_Lock"; Status="ANALYSE_$Status"; Updated=$false}
}
