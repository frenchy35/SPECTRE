<#
    ID: 429 | Name: Path_MTU_BlackHole_Detect
    Artifact de comportement : V4.9.3 Lock
    Description : Activation de la detection de Black Hole pour ameliorer la resilience reseau
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "429"

Write-Host "`n[ATOME 429] Path_MTU_BlackHole_Detect" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="429"; Name="Path_MTU_BlackHole_Detect"; Status="ANALYSE_$Status"; Updated=$false}
}
