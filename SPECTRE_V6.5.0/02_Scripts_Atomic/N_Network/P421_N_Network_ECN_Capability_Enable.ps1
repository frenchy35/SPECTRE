<#
    ID: 421 | Name: ECN_Capability_Enable
    Artifact de comportement : V4.9.3 Lock
    Description : Activation de Explicit Congestion Notification pour reduire les retransmissions detectables
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "421"

Write-Host "`n[ATOME 421] ECN_Capability_Enable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="421"; Name="ECN_Capability_Enable"; Status="ANALYSE_$Status"; Updated=$false}
}
