<#
    ID: 408 | Name: WPAD_Disable_Global
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de Web Proxy Auto-Discovery pour bloquer les redirections de trafic
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "408"

Write-Host "`n[ATOME 408] WPAD_Disable_Global" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="408"; Name="WPAD_Disable_Global"; Status="ANALYSE_$Status"; Updated=$false}
}
