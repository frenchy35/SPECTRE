<#
    ID: 417 | Name: Dhcp_Hostname_Leak_Mitigation
    Artifact de comportement : V4.9.3 Lock
    Description : Empeche l'envoi du nom d'hote dans les paquets DHCP (Anonymisation L2/L3)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "417"

Write-Host "`n[ATOME 417] Dhcp_Hostname_Leak_Mitigation" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="417"; Name="Dhcp_Hostname_Leak_Mitigation"; Status="ANALYSE_$Status"; Updated=$false}
}
