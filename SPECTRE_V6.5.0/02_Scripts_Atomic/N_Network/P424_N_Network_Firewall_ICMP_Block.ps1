<#
    ID: 424 | Name: Firewall_ICMP_Block
    Artifact de comportement : V4.9.3 Lock
    Description : Blocage global de l'echo ICMP (Ping) pour l'invisibilite
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "424"

Write-Host "`n[ATOME 424] Firewall_ICMP_Block" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="424"; Name="Firewall_ICMP_Block"; Status="ANALYSE_$Status"; Updated=$false}
}
