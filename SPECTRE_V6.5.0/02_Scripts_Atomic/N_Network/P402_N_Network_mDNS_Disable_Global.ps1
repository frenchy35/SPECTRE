<#
    ID: 402 | Name: mDNS_Disable_Global
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du service mDNS (Multicast DNS) pour la furtivite locale
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "402"

Write-Host "`n[ATOME 402] mDNS_Disable_Global" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="402"; Name="mDNS_Disable_Global"; Status="ANALYSE_$Status"; Updated=$false}
}
