<#
    ...
    Description : Desactivation de la decouverte MTU du chemin pour eviter le fingerprinting ICMP
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="415"; Name="MTU_Discovery_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
