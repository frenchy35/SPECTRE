...
$Context = Get-SpectrePointRef -PointID "001"
if ($null -eq $Context) { Write-Error "[FATAL] Liaison SSOT echouee pour ID 001"; return }

Write-Host "`n[ATOME 001] AeDebug_Disable" -ForegroundColor Cyan
