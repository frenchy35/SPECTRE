<#
    ID: 006 | Name: Registry_Enumeration_Limit
...
$Context = Get-SpectrePointRef -PointID "006"
if ($null -eq $Context) { Write-Error "[FATAL] Liaison SSOT echouee pour ID 006"; return }

Write-Host "`n[ATOME 006] Registry_Enumeration_Limit" -ForegroundColor Cyan
