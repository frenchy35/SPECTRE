<#
    ID: 522 | Name: Shortcut_Suffix_Remove
...
$Context = Get-SpectrePointRef -PointID "522"
if ($null -eq $Context) { Write-Error "[FATAL] Liaison SSOT echouee pour ID 522"; return }

Write-Host "`n[ATOME 522] Shortcut_Suffix_Remove" -ForegroundColor Cyan
