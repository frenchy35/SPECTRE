<#
    ID: 520 | Name: Action_Center_Disable
...
$Context = Get-SpectrePointRef -PointID "520"
if ($null -eq $Context) { Write-Error "[FATAL] Liaison SSOT echouee pour ID 520"; return }

Write-Host "`n[ATOME 520] Action_Center_Disable" -ForegroundColor Cyan
