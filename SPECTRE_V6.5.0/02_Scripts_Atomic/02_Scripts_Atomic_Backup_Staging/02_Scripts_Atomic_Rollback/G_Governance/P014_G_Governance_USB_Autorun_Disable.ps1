<#
    ID: 014 | Name: USB_Autorun_Disable
    MITRE: T1200 | Severity: 
    Compliance: 
...
$Context = Get-SpectrePointRef -PointID "014"
if ($null -eq $Context) { Write-Error "[FATAL] Context Failure 014"; return }

# --- HEADER VERBOSE (14 ITEMS) ---
Write-Host "`n[ATOME 014] USB_Autorun_Disable" -ForegroundColor Cyan
