<#
    ID: 427 | Name: DNS_Over_HTTPS_Enable
...
$Context = Get-SpectrePointRef -PointID "427"
if ($null -eq $Context) { Write-Error "[FATAL] Context Failure 427"; return }

# --- HEADER VERBOSE (14 ITEMS) ---
Write-Host "`n[ATOME 427] DNS_Over_HTTPS_Enable" -ForegroundColor Cyan
