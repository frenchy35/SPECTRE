<#
    ID: 415 | Name: MTU_Discovery_Disable
...
$Context = Get-SpectrePointRef -PointID "415"
if ($null -eq $Context) { Write-Error "[FATAL] Context Failure 415"; return }

# --- HEADER VERBOSE (14 ITEMS) ---
Write-Host "`n[ATOME 415] MTU_Discovery_Disable" -ForegroundColor Cyan
