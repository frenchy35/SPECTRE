...
$Context = Get-SpectrePointRef -PointID "406"
if ($null -eq $Context) { Write-Error "[FATAL] Context Failure 406"; return }

# --- HEADER VERBOSE (14 ITEMS) ---
Write-Host "`n[ATOME 406] TCP_TTL_Spoof" -ForegroundColor Cyan
