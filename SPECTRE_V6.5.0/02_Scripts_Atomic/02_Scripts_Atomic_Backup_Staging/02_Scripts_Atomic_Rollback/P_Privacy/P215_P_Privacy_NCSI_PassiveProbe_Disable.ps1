<#
    ID: 215 | Name: NCSI_PassiveProbe_Disable
...
$Context = Get-SpectrePointRef -PointID "215"
if ($null -eq $Context) { Write-Error "[FATAL] Context Failure 215"; return }

# --- HEADER VERBOSE (14 ITEMS) ---
Write-Host "`n[ATOME 215] NCSI_PassiveProbe_Disable" -ForegroundColor Cyan
