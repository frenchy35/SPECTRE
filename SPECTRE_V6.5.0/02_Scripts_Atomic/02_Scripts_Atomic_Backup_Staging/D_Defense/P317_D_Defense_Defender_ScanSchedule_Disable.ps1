<#
    ID: 317 | Name: Defender_ScanSchedule_Disable
...
$Context = Get-SpectrePointRef -PointID "317"
if ($null -eq $Context) { Write-Error "[FATAL] Liaison SSOT echouee pour ID 317"; return }

Write-Host "`n[ATOME 317] Defender_ScanSchedule_Disable" -ForegroundColor Cyan
