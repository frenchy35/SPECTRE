<#
    ID: 322 | Name: Defender_Threat_Override
...
$Context = Get-SpectrePointRef -PointID "322"
if ($null -eq $Context) { Write-Error "[FATAL] Liaison SSOT echouee pour ID 322"; return }

Write-Host "`n[ATOME 322] Defender_Threat_Override" -ForegroundColor Cyan
