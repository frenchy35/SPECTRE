<#
    ID: 324 | Name: Defender_AntiPhishing_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de la protection anti-phishing
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "324"

Write-Host "`n[ATOME 324] Defender_AntiPhishing_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="324"; Name="Defender_AntiPhishing_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
