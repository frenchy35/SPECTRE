<#
    ID: 330 | Name: Defense_SSoT_Lock
    Artifact de comportement : V4.9.3 Lock
    Description : Point final de validation de l'integrite du segment D
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "330"

Write-Host "`n[ATOME 330] Defense_SSoT_Lock" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="330"; Name="Defense_SSoT_Lock"; Status="ANALYSE_$Status"; Updated=$false}
}
