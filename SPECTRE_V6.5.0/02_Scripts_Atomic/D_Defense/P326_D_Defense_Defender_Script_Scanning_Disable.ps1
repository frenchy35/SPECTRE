<#
    ID: 326 | Name: Defender_Script_Scanning_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'analyse des scripts (AMSI interfacé)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "326"

Write-Host "`n[ATOME 326] Defender_Script_Scanning_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="326"; Name="Defender_Script_Scanning_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
