<#
    ID: 309 | Name: Defender_IOAV_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'inspection des telechargements (IOAV)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "309"

Write-Host "`n[ATOME 309] Defender_IOAV_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="309"; Name="Defender_IOAV_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
