<#
    ID: 301 | Name: Defender_Antivirus_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation principale de Windows Defender Antivirus
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "301"

Write-Host "`n[ATOME 301] Defender_Antivirus_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="301"; Name="Defender_Antivirus_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
