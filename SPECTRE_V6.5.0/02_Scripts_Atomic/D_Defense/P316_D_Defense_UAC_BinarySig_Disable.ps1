<#
    ID: 316 | Name: UAC_BinarySig_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Ne pas verifier les signatures numeriques pour les executables elevés
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "316"

Write-Host "`n[ATOME 316] UAC_BinarySig_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="316"; Name="UAC_BinarySig_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
