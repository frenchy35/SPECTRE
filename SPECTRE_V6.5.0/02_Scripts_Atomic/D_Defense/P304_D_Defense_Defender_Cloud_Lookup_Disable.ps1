<#
    ID: 304 | Name: Defender_Cloud_Lookup_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Interdiction de la verification cloud des signatures
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "304"

Write-Host "`n[ATOME 304] Defender_Cloud_Lookup_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="304"; Name="Defender_Cloud_Lookup_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
