<#
    ID: 320 | Name: Defender_MAPS_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'adhesion a Microsoft Advanced Protection Service
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "320"

Write-Host "`n[ATOME 320] Defender_MAPS_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="320"; Name="Defender_MAPS_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
