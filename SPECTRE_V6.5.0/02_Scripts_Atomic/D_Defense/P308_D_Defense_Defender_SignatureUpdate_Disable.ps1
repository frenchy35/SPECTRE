<#
    ID: 308 | Name: Defender_SignatureUpdate_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Blocage des mises a jour de definitions Defender
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "308"

Write-Host "`n[ATOME 308] Defender_SignatureUpdate_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="308"; Name="Defender_SignatureUpdate_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
