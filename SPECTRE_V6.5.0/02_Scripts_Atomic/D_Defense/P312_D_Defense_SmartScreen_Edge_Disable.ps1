<#
    ID: 312 | Name: SmartScreen_Edge_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de SmartScreen dans le navigateur Edge
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "312"

Write-Host "`n[ATOME 312] SmartScreen_Edge_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="312"; Name="SmartScreen_Edge_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
