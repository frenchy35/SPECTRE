<#
    ID: 315 | Name: Defender_PUA_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de la detection des Potentially Unwanted Applications (PUA)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "315"

Write-Host "`n[ATOME 315] Defender_PUA_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="315"; Name="Defender_PUA_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
