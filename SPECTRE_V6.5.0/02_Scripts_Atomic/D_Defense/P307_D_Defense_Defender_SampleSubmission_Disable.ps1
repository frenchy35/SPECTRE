<#
    ID: 307 | Name: Defender_SampleSubmission_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'envoi automatique d'echantillons
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "307"

Write-Host "`n[ATOME 307] Defender_SampleSubmission_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="307"; Name="Defender_SampleSubmission_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
