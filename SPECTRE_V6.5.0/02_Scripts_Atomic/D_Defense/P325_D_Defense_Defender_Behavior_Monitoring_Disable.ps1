<#
    ID: 325 | Name: Defender_Behavior_Monitoring_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de l'analyse comportementale
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "325"

Write-Host "`n[ATOME 325] Defender_Behavior_Monitoring_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="325"; Name="Defender_Behavior_Monitoring_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
