<#
    ...
    Description : Desactivation de la planification des scans automatiques
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="317"; Name="Defender_ScanSchedule_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
