<#
    ID: 311 | Name: SecurityHealth_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du Security Health Service (WSC)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "311"

Write-Host "`n[ATOME 311] SecurityHealth_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="311"; Name="SecurityHealth_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
