<#
    ID: 310 | Name: WinDefend_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Forcage du service WinDefend a l'etat desactive
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "310"

Write-Host "`n[ATOME 310] WinDefend_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="310"; Name="WinDefend_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
