<#
    ID: 321 | Name: Defender_NetworkInspection_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du Network Inspection System (NIS)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "321"

Write-Host "`n[ATOME 321] Defender_NetworkInspection_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="321"; Name="Defender_NetworkInspection_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
