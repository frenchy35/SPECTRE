<#
    ...
    Description : Desactivation de la protection en temps reel
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="302"; Name="Defender_RealTime_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
