<#
    ID: 305 | Name: SmartScreen_Apps_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation de SmartScreen pour les applications et fichiers
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "305"

Write-Host "`n[ATOME 305] SmartScreen_Apps_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="305"; Name="SmartScreen_Apps_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
