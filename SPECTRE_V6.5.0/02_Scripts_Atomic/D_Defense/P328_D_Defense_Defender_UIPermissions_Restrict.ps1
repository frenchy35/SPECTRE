<#
    ID: 328 | Name: Defender_UIPermissions_Restrict
    Artifact de comportement : V4.9.3 Lock
    Description : Verrouillage de l'interface utilisateur de Defender
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "328"

Write-Host "`n[ATOME 328] Defender_UIPermissions_Restrict" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="328"; Name="Defender_UIPermissions_Restrict"; Status="ANALYSE_$Status"; Updated=$false}
}
