<#
    ...
    Description : Configuration des menaces severes comme etant autorisees (Ignore)
#>
[CmdletBinding()]
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="322"; Name="Defender_Threat_Override"; Status="ANALYSE_$Status"; Updated=$false}
}
