<#
    ID: 313 | Name: Defender_Exclusion_Path
    Artifact de comportement : V4.9.3 Lock
    Description : Ajout de la racine SPECTRE aux exclusions Defender (Security through redundancy)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "313"

Write-Host "`n[ATOME 313] Defender_Exclusion_Path" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="313"; Name="Defender_Exclusion_Path"; Status="ANALYSE_$Status"; Updated=$false}
}
