<#
    ID: 306 | Name: SmartScreen_Shell_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Configuration du niveau d'alerte SmartScreen sur 'Off'
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "306"

Write-Host "`n[ATOME 306] SmartScreen_Shell_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="306"; Name="SmartScreen_Shell_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
