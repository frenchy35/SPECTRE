<#
    ID: 323 | Name: WscSvc_Service_Kill
    Artifact de comportement : V4.9.3 Lock
    Description : Desactivation du service Security Center (Alerte de securite)
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "323"

Write-Host "`n[ATOME 323] WscSvc_Service_Kill" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="323"; Name="WscSvc_Service_Kill"; Status="ANALYSE_$Status"; Updated=$false}
}
