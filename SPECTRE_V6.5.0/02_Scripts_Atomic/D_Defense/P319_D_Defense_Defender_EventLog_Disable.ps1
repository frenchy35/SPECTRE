<#
    ID: 319 | Name: Defender_EventLog_Disable
    Artifact de comportement : V4.9.3 Lock
    Description : Blocage de l'ecriture des evenements Defender dans les logs
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "319"

Write-Host "`n[ATOME 319] Defender_EventLog_Disable" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="319"; Name="Defender_EventLog_Disable"; Status="ANALYSE_$Status"; Updated=$false}
}
