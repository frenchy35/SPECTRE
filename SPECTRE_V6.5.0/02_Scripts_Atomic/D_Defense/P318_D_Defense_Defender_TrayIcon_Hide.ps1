<#
    ID: 318 | Name: Defender_TrayIcon_Hide
    Artifact de comportement : V4.9.3 Lock
    Description : Masquage de l'icone Defender dans la barre des taches
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "318"

Write-Host "`n[ATOME 318] Defender_TrayIcon_Hide" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="318"; Name="Defender_TrayIcon_Hide"; Status="ANALYSE_$Status"; Updated=$false}
}
