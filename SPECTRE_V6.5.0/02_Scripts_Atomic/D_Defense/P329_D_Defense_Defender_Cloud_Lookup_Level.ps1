<#
    ID: 329 | Name: Defender_Cloud_Lookup_Level
    Artifact de comportement : V4.9.3 Lock
    Description : Fixer le niveau de protection cloud sur 'Basic'
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "329"

Write-Host "`n[ATOME 329] Defender_Cloud_Lookup_Level" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="329"; Name="Defender_Cloud_Lookup_Level"; Status="ANALYSE_$Status"; Updated=$false}
}
