<#
    ID: 314 | Name: Defender_Exclusion_Extension
    Artifact de comportement : V4.9.3 Lock
    Description : Exclusion des scripts PowerShell des analyses Defender
#>
[CmdletBinding()]
...
$Context = Get-SpectrePointRef -PointID "314"

Write-Host "`n[ATOME 314] Defender_Exclusion_Extension" -ForegroundColor Cyan
...
if ($Analyse) {
    ...
    return [PSCustomObject]@{ID="314"; Name="Defender_Exclusion_Extension"; Status="ANALYSE_$Status"; Updated=$false}
}
